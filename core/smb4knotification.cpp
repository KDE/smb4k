/***************************************************************************
    ...
    copyright            : (C) 2010-2021 by Alexander Reinholdt
...
void Smb4KNotification::shareMounted(const SharePtr &share)
{
    ...
    if (share) {
        ...
        notification->setPixmap(
            KIconLoader::global()->loadIcon("folder-network", KIconLoader::NoGroup, 0, KIconLoader::DefaultState, QStringList("emblem-mounted")));
...
void Smb4KNotification::shareUnmounted(const SharePtr &share)
{
    ...
    if (share) {
        ...
        notification->setPixmap(
            KIconLoader::global()->loadIcon("folder-network", KIconLoader::NoGroup, 0, KIconLoader::DefaultState, QStringList("emblem-unmounted")));
        notification->sendEvent();
    }
}
