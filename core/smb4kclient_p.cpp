...
: Smb4KClientBaseJob(parent)
{
    ...
    // Connections
    // 
    connect(m_discoveryClient, SIGNAL(probeMatchReceived(const WSDiscoveryTargetService &)), this, SLOT(slotProbeMatchReceived(const WSDiscoveryTargetService &)));
    connect(m_discoveryClient, SIGNAL(resolveMatchReceived(const WSDiscoveryTargetService &)), this, SLOT(slotResolveMatchReceived(const WSDiscoveryTargetService &)));
