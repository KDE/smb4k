...
Smb4KSearchDialogItem::Smb4KSearchDialogItem( KListWidget *listWidget, Smb4KHost *host )
...
Smb4KSearchDialogItem::Smb4KSearchDialogItem( KListWidget *listWidget, Smb4KShare *share )
...
Smb4KSearchDialogItem::Smb4KSearchDialogItem( KListWidget *listWidget )
...
void Smb4KSearchDialogItem::setupItem()
{
  switch( type() )
  {
    case Host:
...
void Smb4KSearchDialogItem::setMounted( bool mounted )
{
